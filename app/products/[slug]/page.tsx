...
export default function ProductPage({ params }: Props) {
  ...
  const productLd = {
    ...
    "description":"Gentle, ayurvedic-inspired baby care product by Nature Beez. Dermatologically tested and safe for delicate skin.",
    "url": `/products/${slug}`,
    "offers": {
      "@type":"Offer",
    ...
    <section className="container mt-10">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="mt-6">
            <a href="#notify" className="btn btn-primary" aria-label="Notify on launch">Notify on Launch</a>
          </div>
        </div>
      </div>
    </section>
