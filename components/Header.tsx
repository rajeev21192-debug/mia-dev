...
const nav=[{href:'/',label:'Home'},{href:'/products',label:'Products'},{href:'/ingredients',label:'Ingredients & Science'},{href:'/journal',label:'Journal'},{href:'/faq',label:'FAQ'},{href:'/about',label:'About'},{href:'/contact',label:'Contact'}]
